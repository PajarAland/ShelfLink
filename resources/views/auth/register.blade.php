<x-guest-layout>
    <!-- <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4 sm:px-6 lg:px-8"> -->
        <div class="max-w-md w-full space-y-6 px-4 sm:px-0">
            <!-- Header -->
            <div class="text-center">
                <p class="mt-2 font-bold text-gray-600 text-lg sm:text-xl">
                    Create your ShelfLink account
                </p>
            </div>

            <form method="POST" action="{{ route('register') }}" class="mt-6 space-y-5 bg-white p-5 sm:p-8 rounded-2xl">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <x-text-input 
                            id="name" 
                            class="block mt-1 w-full pl-10 pr-4 py-2.5 sm:py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200" 
                            type="text" 
                            name="name" 
                            :value="old('name')" 
                            required 
                ...
                <div class="text-center">
                    <a 
                        href="{{ route('login') }}" 
                        class="inline-flex items-center px-3 sm:px-4 py-2 border border-gray-300 rounded-lg text-xs sm:text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-sm"
                    >
